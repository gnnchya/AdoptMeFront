...
export const readAllPostAdopt = (type,limit,page) => axios.get(`http://127.0.0.1:8080/posts/adopt?keyword=${type}limit=${limit}&page=${page}`)
export const readAllPostLost = (limit,page) => axios.get(`http://127.0.0.1:8080/posts/lost?limit=${limit}&page=${page}`)
...
export const readPostAdopt = (id) => axios.get(`http://127.0.0.1:8080/post/adopt/${id}`)
export const readPostLost = (id) => axios.get(`http://127.0.0.1:8080/post/lost/${id}`)
