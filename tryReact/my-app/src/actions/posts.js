...
export const readAllPostAdopt = (type,limit,page) => axios.get(`http://127.0.0.1:8080/AdoptionPost/adopt?keyword=${type}limit=${limit}&page=${page}`)
export const readAllPostLost = (limit,page) => axios.get(`http://127.0.0.1:8080/LostPetPost?limit=${limit}&page=${page}`)
