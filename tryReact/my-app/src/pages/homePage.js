...
function HomePage(props){
    ...
    const getList = async (e) => {
        ...
        // }
        // try {
        // axios.get(`https://10.0.20.88:8080/AdoptMe/LostPetPost?keyword=${"all"}&limit=${limit}&page=${1}`
        // ).then((response) => {
        ...
        //  }
        //  try {
            const response = await axios.get(`https://10.0.20.88:8080/AdoptMe/LostPetPost?keyword=${"all"}&limit=${limit}&page=${1}`);
            // ).then((response) => {
                console.log(response);
                setPostItems(response.data.data || [])
                console.log(postItem)
